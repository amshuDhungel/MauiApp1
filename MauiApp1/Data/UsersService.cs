...
public static class UsersService
{
    ...
    public static void SeedUsers()
    {
        ...
        if (users == null)
        {
            Create(Guid.Empty, defaultUsername, defaultPassword, Role.Admin);
        }
    }
    ...
    public static User Login(string username, string password)
    {
        ...
        var newUsers = users.ConvertAll<User>(u => u.Id == user.Id ? user : u);
    ...
    public static User GetLoggedInUser() => GetAll().FirstOrDefault(u => u.IsLoggedIn, null);

    public static void Logout(Guid uid)
    {
        List<User> users = GetAll();
        User user = users.FirstOrDefault(x => x.Id == uid);
